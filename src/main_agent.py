...
#     SAVE_DIRECTORY = "./plan_json"

#     print(f"\n--- 💾 Saving plan to {os.path.join(SAVE_DIRECTORY, filename)} ---")
#     try:
...
#         # 4. Join the directory path and filename to create the full path
#         full_path = os.path.join(SAVE_DIRECTORY, filename)

#         # 5. Use the full path to save the file
#         with open(full_path, "w") as f:
#             f.write(plan_json)
            
#         return f"Plan successfully saved to {full_path}."
